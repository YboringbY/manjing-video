...
export async function POST(request: Request) {
  ...
  if (!validateApiProfileBaseUrl(baseUrl)) return NextResponse.json({ code: 400, message: "当前 Base URL 不在可信模型服务域名范围内。当前支持 aifastgate.com、gw.aifastnet.com、zjljzn.ltd、openai.com、volces.com。" }, { status: 400 });
