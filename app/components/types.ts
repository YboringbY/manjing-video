...
export type VideoTask = { id: string; shotId: number; shotTitle: string; provider: string; status: TaskStatus; result: string; providerTaskId?: string; apiProfile?: Pick<ApiProfile, "id">; snapshot?: VideoTaskSnapshot; videoUrl?: string; error?: string; createdAt?: string; updatedAt?: string; completedAt?: string };
